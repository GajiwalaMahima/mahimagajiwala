...
function editRecord(id){
    var f=document.form;
    f.method="post";
    f.action='userPropertyDetails.jsp?id='+id;
    f.submit();
}
</script>
</head>
...
<!--    <div class="py-5">
      ...
      <div class="container">
          <form class="row mb-5" method="post" action="../RegisterUserSearchPropertyServlet">
          ...
          <div class="col-sm-6 col-md-4 col-lg-3 mb-4">
            <input type="submit" onclick="document.forms[0].action = 'Home_1_1.jsp'; return true;" class="btn btn-primary btn-block form-control-same-height rounded-0" value="Search">
          </div>
